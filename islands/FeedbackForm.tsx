...
export default function FeedbackForm() {
  ...
  return (
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      <p class="mb-4 lg:mb-8 font-light text-center text-gray-600 sm:text-xl">
      ...
      <div class="space-y-8">
        <div>
          ...
          <input
            ...
            type="text"
            id="subject"
            class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border shadow-sm focus:ring-primary-500 focus:border-primary-500 border-gray-600"
        ...
        <div class="sm:col-span-2">
          ...
          <textarea
            ...
            id="message"
            rows={6}
            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border focus:ring-primary-500 focus:border-primary-500 border-gray-600"

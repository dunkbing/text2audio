...
export const SITE_DESCRIPTION =
  "Easily convert text into audio with Text2Audio's free online text-to-speech(TTS) tool. Effortlessly create a clear speech for any purpose.";
...
export const SITE_BAR_STYLES = "text-black flex justify-between px-3 py-6";
